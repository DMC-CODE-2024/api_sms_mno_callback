...
public class Notification implements Serializable {
    ...
    public Notification(LocalDateTime createdOn, LocalDateTime modifiedOn, String channelType, String message, Long featureId, String featureTxnId, String featureName, String subFeature, Integer status, String referTable, String email, String operatorName, LocalDateTime notificationSentTime, String corelationId, String msgLang, int deliveryStatus, LocalDateTime deliveryTime, String sendSmsInterface) {
