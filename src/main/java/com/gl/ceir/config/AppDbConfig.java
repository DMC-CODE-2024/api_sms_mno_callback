...
@EnableJpaRepositories(basePackages = {"com.gl.ceir.config.repository.app"}, entityManagerFactoryRef = "appEntityManagerFactory", transactionManagerRef = "appTransactionManager")
...
public class AppDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean appEntityManagerFactory(@Qualifier("appDataSource") DataSource dataSource, EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages(new String[] { "com.gl.ceir.config.model.app" }).persistenceUnit("app")
    ...
    public PlatformTransactionManager appTransactionManager(@Qualifier("appEntityManagerFactory") LocalContainerEntityManagerFactoryBean appEntityManagerFactory) {
        return (PlatformTransactionManager)new JpaTransactionManager(Objects.<EntityManagerFactory>requireNonNull(appEntityManagerFactory.getObject()));
    }
